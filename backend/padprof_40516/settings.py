"""
Django settings for padprof_40516 project.
...
ROOT_URLCONF = 'padprof_40516.urls'
...
WSGI_APPLICATION = 'padprof_40516.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "padprof_40516 API",
    "DESCRIPTION": "API documentation for padprof_40516 App",
    "VERSION": "v1",
}
